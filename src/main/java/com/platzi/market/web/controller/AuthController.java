...
import com.platzi.market.domain.service.PlatziUserDetailsServices;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request) {
        try {
            ...
            UserDetails userDetails = platziUserDetailsServices.loadUserByUsername(request.getUsername());
